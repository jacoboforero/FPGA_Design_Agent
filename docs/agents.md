...
- **Debug**
  ...
  - Success: interface preserved, code written, rationale persisted to task memory, and local deterministic validation passes for touched artifacts (TB lint for TB edits, RTL lint for RTL edits)
